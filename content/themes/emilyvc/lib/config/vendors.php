...
function wpst_gforms_submit_button( $btn, $form ){
    $output  = '<button type="submit" class="btn btn--primary btn--large btn--icon" id="gform_submit_button_' . $form['id'] . '">';
    $output .= $form['button']['text'];
    $output .= '<span class="icon icon--medium icon--arrow-right"</span></button>';
